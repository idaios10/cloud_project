...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://orion-proxy:1027/v2/subscriptions/', // use orion-proxy (PEP Proxy for Orion CB) IP address and port instead of Orion CB's 
  ...
  CURLOPT_POSTFIELDS =>'{
  "description": "Update user on changes made for this product",
  "subject": {
      "entities": [
          {
              "id": "'.$id.'",
   ...
   "notification": {
      "http": {
          "url": "http://fiware-pep-proxy:3051/api/orion/create.php" 
      }, 
      "attrs": [
        "date_of_withdrawal"
    ]   },
